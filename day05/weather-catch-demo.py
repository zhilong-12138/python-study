...
# @Last Modified by:   zhiLong
# @Last Modified time: 2026-01-16 09:47:00
# 中国天气网的接口。。。
# 项目地址 https://github.com/monkey-hjy/python-spider/blob/master/weather/weather.py
import requests
...
if __name__ == '__main__':
    ...
    # 调用获取HTML的方法
    html = get_html(url)
    file_path = '/Users/monkeyjon/work/file/中国天气网城市信息.csv'
